...
class YachtDice():
    ...
    def change_name(self):
        ...
        self.reply_json["contents"][0]["body"]["contents"][3]["contents"][1]["text"] = self.player1_name
        self.reply_json["contents"][0]["body"]["contents"][5]["contents"][1]["text"] = self.player2_name
    def roll_dice(self):
        for i in range(0, 5):
    ...
    def check_dice(self, dice_type):
        ...
        if dice_type <= 7:
            ...
            return (count[1] == 5 and self.dice_state.count(3) and self.dice_state.count(4)) or (count[1] == 3 and not (self.dice_state.count(1) and self.dice_state.count(6)))
        elif dice_type == 11:
